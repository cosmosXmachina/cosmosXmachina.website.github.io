...
const ERROR_COPY = {
  it: {
    ACTION_IN_PROGRESS: "Un'altra azione dimostrativa e ancora in corso.", ACTION_NOT_FOUND: "Questa azione non e disponibile.", DEMO_NOT_FOUND: "Questa dimostrazione non e disponibile.",
    ...
    REQUEST_ABORTED: "La richiesta e stata annullata.", REQUEST_TOO_LARGE: "La richiesta supera il limite della dimostrazione.", ROLE_FORBIDDEN: "Il ruolo selezionato non puo eseguire questa azione.",
  ...
  en: {
    ACTION_IN_PROGRESS: "Another demonstration action is still running.", ACTION_NOT_FOUND: "This action is unavailable.", DEMO_NOT_FOUND: "This demonstration is unavailable.",
    ...
    REQUEST_ABORTED: "The request was cancelled.", REQUEST_TOO_LARGE: "The request exceeds the demonstration limit.", ROLE_FORBIDDEN: "The selected role cannot perform this action.",
